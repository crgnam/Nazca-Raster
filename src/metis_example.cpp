...
// Build with
// g++ metis_example.cpp -I../external/METIS/include -L../external/METIS/prefix/lib -lmetis -L../external/GKlib/prefix/lib -lGKlib
...
int main(){
    ...
    for(uint part_i = 0; part_i < nVertices; part_i++){
